...
public class RobotContainer {
    ...
    private final FuelCommandsClaude fuelCommands = null;
    ...
    private void configureBindings() {
        ...
        driver.rightTrigger(0.5).whileTrue(
            FuelCommandsClaude.poseAlignAndShoot(shooter, indexer, /*intake,*/ drivetrain,
        ...
        operator.a().whileTrue(
            FuelCommandsClaude.shootWithPreset(shooter, indexer, ShooterSubsystem.ShotPreset.TRENCH));
        operator.b().whileTrue(
            FuelCommandsClaude.shootWithPreset(shooter, indexer, ShooterSubsystem.ShotPreset.CLOSE));
        operator.x().whileTrue(
            FuelCommandsClaude.shootWithPreset(shooter, indexer, ShooterSubsystem.ShotPreset.TOWER));
        operator.y().whileTrue(
            FuelCommandsClaude.shootWithPreset(shooter, indexer, ShooterSubsystem.ShotPreset.FAR));

        operator.rightBumper().whileTrue(FuelCommandsClaude.shootPass(shooter, indexer));
        ...
        operator.leftTrigger().whileTrue(FuelCommandsClaude.runAirPopper(indexer, shooter, intake));
