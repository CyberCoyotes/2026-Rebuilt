...
public class LimelightHelpers_Scoy {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        DoubleArrayEntry poseEntry = LimelightHelpers_Scoy.getLimelightDoubleArrayEntry(limelightName, entryName);
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightHelpers_Scoy.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightHelpers_Scoy.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightHelpers_Scoy.LimelightResults results = new LimelightHelpers_Scoy.LimelightResults();
        if (mapper == null) {
